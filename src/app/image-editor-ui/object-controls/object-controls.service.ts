...
export class ObjectControlsService {
    ...
    public reposition() {
        ...
        if (obj.type === 'i-text' && TEXT_CONTROLS_PADDING) {
            width += TEXT_CONTROLS_PADDING * 2;
            height += TEXT_CONTROLS_PADDING * 2;
            left -= TEXT_CONTROLS_PADDING;
            top -= TEXT_CONTROLS_PADDING;
        }
